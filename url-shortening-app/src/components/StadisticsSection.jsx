    ...
    <section id="advanced-stadistics">
      <div className="advanced-stadistics-container">
        <div className="advanced-stadistics-texts">
          <h3 className='advanced-stadistics-title'>Advanced Stadistics</h3>
        ...
        <div className="boxes-container">
          <div className="box-info">
            ...
            <h4 className="box-title">Brand Recognition</h4>
          ...
          <div className="box-info">
            ...
            <h4 className="box-title">Detailed Records</h4>
          ...
          <div className="box-info">
            ...
            <h4 className="box-title">Fully Customizable</h4>
